...
#define DELAIS_CHANGE_COMPORT 20
...
{
	cout << "descente etape 0 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
	...
	cout << "descente etape finale => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
	return vit;
}
	...
	for(int i(0); i < 10000; i++)
	{
		...
		if(autorisationChangementComportement)
		{
			if(tirageComportementAleatoire(comportementActuel) == 1)
			{
		        ...
		        cout << "arret complet => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		    }
		}
		else
		{ // Boucle d'attente
		...
		switch (comportementActuel)
		{
			...
			case EcranPivot_Positif:
		    	...
		    	if(vit[2] < V3_MAX) 
					...
					if(vit[2] > 1) cout << " Comportement 1 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		    ...
		    case EcranPivot_Negatif:
				...
				if(vit[2] < -1) cout << " Comportement 2 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
				break;
		    ...
		    case PetitsCercles_Positif:
				...
				if(vit[1] > 1) cout << " Comportement 3 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case PetitsCercles_Negatif:
		        ...
		        if(vit[1] < -1) cout << " Comportement 4 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case GrandsCercles_Positif:
		        ...
		        if(vit[0] > 1) cout << " Comportement 5 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case GrandsCercles_Negatif:
		        ...
		        if(vit[0] < -1) cout << " Comportement 6 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case MouvementsAmples_PivotRapide_Positif:
		        ...
		        if((vit[0] > 1) || (vit[1] > 1) || (vit[2] > 1)) cout << " Comportement 7 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case MouvementsAmples_PivotRapide_Negatif:
		        ...
		        if(vit[2] > -V3_MAX) 
		       	...
		       	if((vit[0] < -1) || (vit[1] < -1) || (vit[2] < -1)) cout << " Comportement 8 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;	
		        break;
		    ...
		    case PetitesOscillations:
		        ...
		        if (delaisOscillations == -DELAIS_OSCI_COURT) delaisOscillations = 1;
	           	...
	           	cout << " Comportement 9 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
		    ...
		    case GrandesOscillations:
		        ...
		        if (delaisOscillations == -DELAIS_OSCI_LONG) delaisOscillations = 1;
	          	...
	          	if((vit[0] > 1) || (vit[0] < -1)) cout << " Comportement 10 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
			    break;
		    ...
		    // Pivot
		        ...
		        else
		        {
	          	...
	          	if((vit[2] > 1) || (vit[2] < -1) || (vit[0] > 1) || (vit[1] > 1)) 
	          		cout << " Comportement 11 => vit1 = " << vit[0] << "; vit2 = " << vit[1] << "; vit3 = " << vit[2] << endl;
		        break;
